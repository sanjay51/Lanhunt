...
public class OpenLocationBox extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OpenLocationBox frame = new OpenLocationBox();
					frame.setVisible(true);
				} catch (Exception e) {
					LogWindow.addErrorLog("OpenLocationBox(1): "+e.getLocalizedMessage());
					e.printStackTrace();
				}
			}
		});
	 ...
	 * Create the frame.
	 */
	public OpenLocationBox(String location) {
		this();
	...
	class OpenLocationEngine extends Thread{
		...
		public void launchFile(File file)
		  ...
		  public void launchFile(String filePath)
		  {
		    ...
		    {
		    	LogWindow.addErrorLog("OpenLocationBox(3): "+ex.getLocalizedMessage());
		...
		public void setFrame(OpenLocationBox o){
			this.olb=o;
		}
